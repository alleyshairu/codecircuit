<div class="w-full my-4">
    <div role="tablist" class="tabs grid-cols-5">
        ...
        <a href="{{ route('portal.chapter.problems', $problem->chapter_id) }}" class="tab-item"
            data-state="{{ request()->routeIs('portal.chapter.problems') ? 'active' : '' }}">Chapter Problems</a>
