            ...
            <nav class="bg-brand-yellow">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4 border-b">
                    ...
                    <div class="flex items-center space-x-6 rtl:space-x-reverse">
                        ...
                        <a href="/register"
                            class="uppercase font-black border-2 border-black bg-brand-yellow px-3 py-1.5 text-center rounded-md">Get Started</a>
                    </div>
                </div>
            </nav>
        </header>
        ...
        <footer class="bg-brand-gray">
            <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="">
                    ...
                    <div>
                        <h3 class="mb-6 text-sm font-black uppercase">Company</h3>
                        <ul class="text-sm">
                            <li class="mb-4">
